...
@Component({
  selector: 'app-profile-cashier',
  templateUrl: './profile-cashier.component.html',
  styleUrls: ['./profile-cashier.component.css']
})
export class ProfileCashierComponent implements OnInit {
  public userData: any[];
